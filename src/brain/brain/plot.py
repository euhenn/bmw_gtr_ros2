...
# === --- PLOT 1: Errors (MPC vs Detection) --- ===
fig, axs = plt.subplots(2, 1, figsize=(10, 6), sharex=True)

# ==================================================
# Subplot 1: Lateral error (MPC e_y vs Detection e2)
# ==================================================
axs[0].plot(t, e_y, color="C0", linewidth=2, label=r'MPC $e_y$')
axs[0].plot(t, e2, color="C2", linewidth=2, linestyle="--", label=r'Detection $e_2$')

axs[0].set_ylabel(r'Lateral error [$\mathrm{m}$]', fontsize=12)
axs[0].set_title("Lateral Error: MPC vs Vision", fontsize=14, fontweight='bold')
axs[0].legend(fontsize=11, loc='upper right')
axs[0].grid(True, linestyle="--", alpha=0.6)

# ==================================================
# Subplot 2: Heading / angular error (MPC e_psi vs Detection e3)
# ==================================================
axs[1].plot(t, e_psi, color="C1", linewidth=2, label=r'MPC $e_{\psi}$')
axs[1].plot(t, e3, color="C3", linewidth=2, linestyle="--", label=r'Detection $e_3$')

axs[1].set_xlabel(r'Time [$\mathrm{s}$]', fontsize=12)
axs[1].set_ylabel(r'Angular error [$\mathrm{rad}$]', fontsize=12)
axs[1].set_title("Heading Error: MPC vs Vision", fontsize=14, fontweight='bold')

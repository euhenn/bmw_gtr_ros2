...
#include "bmw_gtr/msg/localisation.hpp"
...
namespace gazebo
{
    ...
    {   
        ...
        private: 
            ...
            rclcpp::Publisher<bmw_gtr::msg::Localisation>::SharedPtr gps_publisher_;
            
            bmw_gtr::msg::Localisation gps_msg_;
            
            std::deque<bmw_gtr::msg::Localisation> gps_history_;

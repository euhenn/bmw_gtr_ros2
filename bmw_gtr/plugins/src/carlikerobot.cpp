    ...
    namespace carlikerobot{
        ...
        */
	    ...
	    CFrontWheelsSpeed::CFrontWheelsSpeed(float             axletrack, 
                                             ...
                                             const common::PID &pidRight, // <-- pass by const ref
                                             const common::PID &pidLeft,  // <-- pass by const ref
        ...
        void CFrontWheelsSpeed::update(float steeringAngle_deg, float speed_meter_per_sec)
        {
            ...
            if(DEBUG)
            {
                RCLCPP_INFO(rclcpp::get_logger("carlikerobot"), "Front speed:\t\t[%f, %f]", l_Vr_L, l_Vr_R);
            }
        ...
        CRearWheelsSpeed::CRearWheelsSpeed(float             f_axletrack,
                                           ...
                                           const common::PID &f_pidRight,
                                           const common::PID &f_pidLeft,
        ...
        void CRearWheelsSpeed::update(float f_steerAngle_deg,float f_Vr_m_meterpsec)
        {
            ...
            if(DEBUG)
            {
                RCLCPP_INFO(rclcpp::get_logger("carlikerobot"), "Rear speed:\t\t[%f, %f]",l_Vr_L, l_Vr_R);
            }
        ...
        void CSteerWheelsAngle::update(float f_steerAngle_deg)
        {
            ...
            if(DEBUG)
            {
                RCLCPP_INFO(rclcpp::get_logger("carlikerobot"), "Angle:\t\t\t[%f, %f]", l_steer_left*180.0/PI,l_steer_right*180.0/PI);
                RCLCPP_INFO(rclcpp::get_logger("carlikerobot"), "====================================================================");
            }

...
class AutomobileDataDisplay(AutomobileDataSimulator):
    ...
    def display_data(self):
        ...
        print(f"IMU yaw_true:     {self.yaw_true:.3f} rad")
        print(f"True Position:    x_true={self.x_true:.3f}, y_true={self.y_true:.3f}")
        print(f"Localisation:     x_est={self.x_est:.3f}, y_est={self.y_est:.3f}")
